...
for page in range(1,3):
    browser.get(f'https://www.ihale.gov.tr/SerbestKursu.aspx#sayfa-{page}')#f"https://www.ihale.gov.tr/SerbestKursu.aspx#sayfa-{page}"
    
    time.sleep(5)
    soup = BeautifulSoup(browser.page_source, "html.parser")
    with open("/home/ubuntu/webscraper/output1.html", "w") as file:
        file.write(str(soup))
...
print(df)
df.to_csv("/home/ubuntu/webscraper/kik.csv", index=False)